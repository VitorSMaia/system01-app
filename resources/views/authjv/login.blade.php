        ...
        <div class="flex w-1/2 justify-center items-center bg-white">
            ...
            <form class="bg-white" action="{{ route('login.do') }}" method="POST">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none" type="text" name="login" id="login" placeholder="Email Address" />
                </div>
                ...
                <button class="block max-w-min bg-indigo-600 py-2 rounded-2xl text-white font-semibold mb-2 px-3" type="submit">Login</button>
